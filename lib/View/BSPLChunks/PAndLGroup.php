...
class View_BSPLChunks_PAndLGroup extends View {
	...
	function init(){
		...
		$result= $this->add('Model_Scheme')->getOpeningBalanceByGroup($this->api->nextDate($this->to_date),$forPandL=$bs['is_pandl'],$this->branch,$bs,array('PAndLGroup','account','PAndLGroup'));
