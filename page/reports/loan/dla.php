...
class page_reports_loan_dla extends Page {
	...
	function init(){
		...
		$form->addField('dropdown','report_type')->setValueList(array('nodues'=>'No Dues','duelist'=>'Due List','hardlist'=>'Hard List','npa'=>'NPA List','time_collapse'=>'Time Collapse'));
		...
		if($to_date)
				$account_model->addCondition('created_at','<',$to_date);
