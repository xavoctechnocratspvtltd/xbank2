...
class page_schemes_CC extends Page{
	function init(){
		...
		$crud->addHook('myupdate',function($crud,$form){
			...
			$cc_scheme_model->createNewScheme($form['name'],$form['balance_sheet_id'], ACCOUNT_TYPE_CC, ACCOUNT_TYPE_CC, $is_loanType=true, $other_values=$form->getFieldValues(),$form,$this->api->now);
			return true;
		});
