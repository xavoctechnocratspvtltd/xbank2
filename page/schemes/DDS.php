...
class page_schemes_DDS extends Page{
	function init(){
		...
		$crud->setModel($scheme_dds_model,array('name','Interest','ActiveStatus','balance_sheet_id','MaturityPeriod','SchemeGroup','MinLimit','MaxLimit','CRPB','AccountOpenningCommission','CollectorCommissionRate','percent_loan_on_deposit','no_loan_on_deposit_till'));
