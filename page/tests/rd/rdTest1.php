...
class page_tests_rd_rdTest1 extends Page_Tester {
    // Class Variables
    public $title = 'Account Testing';
    public $account_type = 'Recurring'; //Loan,CC,FixedAndMis,Default,SavingAndCurrent,Recurring,DDS
    ...
    public $scheme_id=158; // NEW RD 3 YEAR
    ...
    public $account_type_in_account = 'Recurring'; // Account Type
    ...
    public $account_flow=array(
            ...
            'flow'=>array(
                    ...
                    '2014-07-21'=> array(1500),
                    '2014-10-02'=> array(1000),
                    '2014-12-02'=> array(1500),
                    '2015-03-02'=> array(1000),
                    '2015-05-30'=> array(2000),
                    '2015-06-15'=> array(2000),
